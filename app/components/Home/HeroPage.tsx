    ...
    <div className='w-full py-[3rem]'>
        <section className='maxContainer xl:w-[80%] w-[90%] mx-auto flex lg:flex-row flex-col justify-between gap-10'>
            <div className='2xl:w-[45%] xl:flex-1 lg:w-[400px] md:w-[550px] sm:w-[500px] w-full'>
                <h2 className='arima 2xl:text-[3.5rem] xl:text-[3rem] lg:text-[2.5rem] md:text-[3.5rem] sm:text-[3rem] text-[2.7rem] font-bold 2xl:leading-[4.5rem] lg:leading-[3.5rem] md:leading-[4.5rem] sm:leading-[4rem] leading-[3.5rem]'>Master Python, DevOps, and Security <span className='font-extralight 2xl:text-[3rem]'>— One Day at a Time</span> </h2>
                <p className='lg:pt-0 pt-6 xl:text-[1.1rem] lg:text-[0.9rem] md:text-[1.1rem] text-[1rem] text-gray-400'>
