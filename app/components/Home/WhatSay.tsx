  ...
  return (
    <div className='w-full py-[4rem] bg-app-primary'>
        <section className='maxContainer w-[80%] mx-auto'>
            <div className='w-full flex xs:flex-row flex-col justify-between xs:items-center xs:gap-8 gap-3'>
                <h2 className='md:text-3xl xs:text-2xl text-xl text-white font-semibold'>What do <span className='text-app-primary-light'>they say</span> about you?</h2>
